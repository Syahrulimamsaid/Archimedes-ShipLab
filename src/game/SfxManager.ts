...
export const SFX_KEYS = {
    ...
    keteranganAnatomi: "sfx.keterangan.anatomi",
...
/** The 9 `Struktur Dasar Berganda` hull component narration lines, keyed by
 * the component's 1-based `number` (see HullComponentsData.ts). */
export function anatomiNarrationKey(componentNumber: number) {
    return `sfx.anatomi.${componentNumber}`;
}
