...
**Archimedes-ShipLab** adalah media pembelajaran interaktif berbasis simulasi yang dirancang untuk membantu taruna memahami struktur kapal dan prinsip stabilitas secara visual, praktis, dan menyenangkan — dibangun dengan [Phaser](https://phaser.io) (WebGL/Canvas game engine) di dalam aplikasi React + TypeScript.
